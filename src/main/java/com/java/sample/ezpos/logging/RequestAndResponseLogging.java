package com.java.sample.ezpos.logging;
...
@Order(2)
@Log4j2
public class RequestAndResponseLogging extends OncePerRequestFilter {
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
		...
		log.info("RequestAndResponseLoggingFilter doFilterInternal  Order 2");
		...
		log.info("Out RequestAndResponseLoggingFilter doFilterInternal");
